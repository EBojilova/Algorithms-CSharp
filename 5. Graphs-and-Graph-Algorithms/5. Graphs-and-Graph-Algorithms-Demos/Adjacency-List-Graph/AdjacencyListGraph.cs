...
class Graph
{
    ...
    {
        // ChildNodes sa izhodiastite rebra, ako ni traibvat vhodistite rebra, ste imame oste edin spisak
        this.ChildNodes = childNodes;
        this.NodeNames = nodeNames;
    }
}

// https://quickgraph.codeplex.com/wikipage?title=AdjacencyGraph&referringTitle=Documentation
// vanshna biblioteka, koiato dori moje da risuva graph
// ima dadedni i algoritmi
