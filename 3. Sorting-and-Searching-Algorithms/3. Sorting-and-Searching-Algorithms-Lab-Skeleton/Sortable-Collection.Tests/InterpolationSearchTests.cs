namespace Sortable_Collection.Tests
{
    ...
    public class InterpolationSearchTests
    {
        ...
        // Below test take too much time, and not all of the tests can be run
        //[TestMethod]
        ...
        //    {
        //        int resultIndex = collection.InterpolationSearch(element);

        //        Assert.AreEqual(element, collection.Items[resultIndex]);
        //    }
        //}
        ...
        //    Assert.AreEqual(3, collection.Items[result]);
        //}

        private void ApplyDelegates(ref SortableCollection<int> collection)
        {
            collection = new SortableCollection<int>(collection.Items, this.Subtract, this.Multiply);
        }
